...
func TestAccInfobloxFixedAddressBasic(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: composeConfig(testAccProviderBaseConfig, testAccCheckInfobloxNetworkCreate(), testAccCheckInfobloxRangeCreateStatic(), testAccCheckInfobloxFixedAddressCreateStatic(), testAccCheckInfobloxFixedAddressCreateFromNetwork(), testAccCheckInfobloxFixedAddressCreateFromRange()),
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("infoblox_fixed_address.static", "extensible_attributes.Location", fmt.Sprintf("{\"value\":\"CollegeStation\",\"type\":\"STRING\",\"inheritance_source\":{\"_ref\":\"%s\"}}", os.Getenv("INFOBLOX_INHERITANCE_SOURCE"))),
					resource.TestCheckResourceAttr("infoblox_fixed_address.static", "extensible_attributes.Owner", fmt.Sprintf("{\"value\":\"leroyjenkins\",\"type\":\"STRING\",\"inheritance_source\":{\"_ref\":\"%s\"}}", os.Getenv("INFOBLOX_INHERITANCE_SOURCE"))),
					...
					resource.TestCheckResourceAttr("infoblox_fixed_address.network", "extensible_attributes.Location", fmt.Sprintf("{\"value\":\"CollegeStation\",\"type\":\"STRING\",\"inheritance_source\":{\"_ref\":\"%s\"}}", os.Getenv("INFOBLOX_INHERITANCE_SOURCE"))),
					resource.TestCheckResourceAttr("infoblox_fixed_address.network", "extensible_attributes.Owner", fmt.Sprintf("{\"value\":\"leroyjenkins\",\"type\":\"STRING\",\"inheritance_source\":{\"_ref\":\"%s\"}}", os.Getenv("INFOBLOX_INHERITANCE_SOURCE"))),
					...
					resource.TestCheckResourceAttr("infoblox_fixed_address.range", "extensible_attributes.Location", fmt.Sprintf("{\"value\":\"CollegeStation\",\"type\":\"STRING\",\"inheritance_source\":{\"_ref\":\"%s\"}}", os.Getenv("INFOBLOX_INHERITANCE_SOURCE"))),
					resource.TestCheckResourceAttr("infoblox_fixed_address.range", "extensible_attributes.Owner", fmt.Sprintf("{\"value\":\"leroyjenkins\",\"type\":\"STRING\",\"inheritance_source\":{\"_ref\":\"%s\"}}", os.Getenv("INFOBLOX_INHERITANCE_SOURCE"))),
					...
					resource.TestCheckResourceAttr("data.infoblox_fixed_address.ip_address", "extensible_attributes.Location", fmt.Sprintf("{\"value\":\"CollegeStation\",\"type\":\"STRING\",\"inheritance_source\":{\"_ref\":\"%s\"}}", os.Getenv("INFOBLOX_INHERITANCE_SOURCE"))),
					resource.TestCheckResourceAttr("data.infoblox_fixed_address.ip_address", "extensible_attributes.Owner", fmt.Sprintf("{\"value\":\"leroyjenkins\",\"type\":\"STRING\",\"inheritance_source\":{\"_ref\":\"%s\"}}", os.Getenv("INFOBLOX_INHERITANCE_SOURCE"))),
