		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					testAccCheckInfobloxExtensibleAttribute("infoblox_fixed_address.static", "extensible_attributes.Location", "CollegeStation"),
					testAccCheckInfobloxExtensibleAttribute("infoblox_fixed_address.static", "extensible_attributes.Owner", "leroyjenkins"),
					...
					testAccCheckInfobloxExtensibleAttribute("infoblox_fixed_address.network", "extensible_attributes.Location", "CollegeStation"),
					testAccCheckInfobloxExtensibleAttribute("infoblox_fixed_address.network", "extensible_attributes.Owner", "leroyjenkins"),
					...
					testAccCheckInfobloxExtensibleAttribute("infoblox_fixed_address.range", "extensible_attributes.Location", "CollegeStation"),
					testAccCheckInfobloxExtensibleAttribute("infoblox_fixed_address.range", "extensible_attributes.Owner", "leroyjenkins"),
					...
					testAccCheckInfobloxExtensibleAttribute("data.infoblox_fixed_address.ip_address", "extensible_attributes.Location", "CollegeStation"),
					testAccCheckInfobloxExtensibleAttribute("data.infoblox_fixed_address.ip_address", "extensible_attributes.Owner", "leroyjenkins"),
