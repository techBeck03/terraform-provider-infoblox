		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("infoblox_host_record.static", "extensible_attributes.Location", fmt.Sprintf("{\"value\":\"CollegeStation\",\"type\":\"STRING\",\"inheritance_source\":{\"_ref\":\"%s\"}}", os.Getenv("INFOBLOX_INHERITANCE_SOURCE"))),
					resource.TestCheckResourceAttr("infoblox_host_record.static", "extensible_attributes.Owner", fmt.Sprintf("{\"value\":\"leroyjenkins\",\"type\":\"STRING\",\"inheritance_source\":{\"_ref\":\"%s\"}}", os.Getenv("INFOBLOX_INHERITANCE_SOURCE"))),
					...
					resource.TestCheckResourceAttr("infoblox_host_record.network", "extensible_attributes.Location", fmt.Sprintf("{\"value\":\"CollegeStation\",\"type\":\"STRING\",\"inheritance_source\":{\"_ref\":\"%s\"}}", os.Getenv("INFOBLOX_INHERITANCE_SOURCE"))),
					resource.TestCheckResourceAttr("infoblox_host_record.network", "extensible_attributes.Owner", fmt.Sprintf("{\"value\":\"leroyjenkins\",\"type\":\"STRING\",\"inheritance_source\":{\"_ref\":\"%s\"}}", os.Getenv("INFOBLOX_INHERITANCE_SOURCE"))),
					...
					resource.TestCheckResourceAttr("infoblox_host_record.range", "extensible_attributes.Location", fmt.Sprintf("{\"value\":\"CollegeStation\",\"type\":\"STRING\",\"inheritance_source\":{\"_ref\":\"%s\"}}", os.Getenv("INFOBLOX_INHERITANCE_SOURCE"))),
					resource.TestCheckResourceAttr("infoblox_host_record.range", "extensible_attributes.Owner", fmt.Sprintf("{\"value\":\"leroyjenkins\",\"type\":\"STRING\",\"inheritance_source\":{\"_ref\":\"%s\"}}", os.Getenv("INFOBLOX_INHERITANCE_SOURCE"))),
					...
					resource.TestCheckResourceAttr("data.infoblox_host_record.hostname", "extensible_attributes.Location", fmt.Sprintf("{\"value\":\"CollegeStation\",\"type\":\"STRING\",\"inheritance_source\":{\"_ref\":\"%s\"}}", os.Getenv("INFOBLOX_INHERITANCE_SOURCE"))),
					resource.TestCheckResourceAttr("data.infoblox_host_record.hostname", "extensible_attributes.Owner", fmt.Sprintf("{\"value\":\"leroyjenkins\",\"type\":\"STRING\",\"inheritance_source\":{\"_ref\":\"%s\"}}", os.Getenv("INFOBLOX_INHERITANCE_SOURCE"))),
