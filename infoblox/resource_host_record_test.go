		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					testAccCheckInfobloxExtensibleAttribute("infoblox_host_record.static", "extensible_attributes.Location", "CollegeStation"),
					testAccCheckInfobloxExtensibleAttribute("infoblox_host_record.static", "extensible_attributes.Owner", "leroyjenkins"),
					...
					testAccCheckInfobloxExtensibleAttribute("infoblox_host_record.network", "extensible_attributes.Location", "CollegeStation"),
					testAccCheckInfobloxExtensibleAttribute("infoblox_host_record.network", "extensible_attributes.Owner", "leroyjenkins"),
					...
					testAccCheckInfobloxExtensibleAttribute("infoblox_host_record.range", "extensible_attributes.Location", "CollegeStation"),
					testAccCheckInfobloxExtensibleAttribute("infoblox_host_record.range", "extensible_attributes.Owner", "leroyjenkins"),
					...
					testAccCheckInfobloxExtensibleAttribute("data.infoblox_host_record.hostname", "extensible_attributes.Location", "CollegeStation"),
					testAccCheckInfobloxExtensibleAttribute("data.infoblox_host_record.hostname", "extensible_attributes.Owner", "leroyjenkins"),
